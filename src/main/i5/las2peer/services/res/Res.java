...
public class Res extends RESTService {
  ...
  @Api
  @SwaggerDefinition(
      info = @Info(title = "7015", version = "$Metadata_Version$",
          description = "$Metadata_Description$",
          termsOfService = "$Metadata_Terms$",
          contact = @Contact(name = "", email = "CAEAddress@gmail.com") ,
          license = @License(name = "BSD",
              url = "https://github.com/PhilCAEOrg/microservice-7015/blob/master/LICENSE.txt") ) )
  @Path("/")
  ...
  @ApiResponses(value = {
       @ApiResponse(code = HttpURLConnection.HTTP_OK, message = "ere")
  })
  ...
  public Response getSongs() {
    ...
    // ere
    boolean ere_condition = true;
    if(ere_condition) {
      JSONObject srrr = new JSONObject();

      

      return Response.status(HttpURLConnection.HTTP_OK).entity(srrr.toJSONString()).build();
    }
    return null;
  }
